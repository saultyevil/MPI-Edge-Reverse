...
image1 = np.loadtxt("nonblocking1.txt")
image2 = np.loadtxt("nonblocking2.txt")
image3 = np.loadtxt("nonblocking3.txt")
image4 = np.loadtxt("nonblocking4.txt")
...
# shouldn't need to apply the correct fudge for this data
...
ax1.grid()
fig.tight_layout()
plt.savefig("np_runtime_nonblockingrev.pdf")
plt.close()
...
ax1.grid()
fig.tight_layout()
plt.savefig("np_speedup_nonblockingrev.pdf")
plt.close()
...
ax1.grid()
fig.tight_layout()
plt.savefig("np_periter_nonblockingrev.pdf")
plt.close()
...
ax1.grid()
fig.tight_layout()
plt.savefig("np_parallelefficiency_nonblockingrev.pdf")
plt.close()
...
ax1.grid()
fig.tight_layout()
plt.savefig("np_totalruntime_nonblockingrev.pdf")
plt.close()
...
ax1.grid()
# time per iter
ax2.semilogy(image1[:, 1], (image1[:, 2]/1500)*1000, 'x-',
             label=label_iters[0])
ax2.semilogy(image2[:, 1], (image2[:, 2]/1100)*1000, 'D-',
             label=label_iters[1])
ax2.semilogy(image3[:, 1], (image3[:, 2]/1500)*1000, '^-',
             label=label_iters[2])
ax2.semilogy(image4[:, 1], (image4[:, 2]/1300)*1000, 's-',
             label=label_iters[3])
...
ax2.grid()
fig.tight_layout()
plt.savefig("np_graphs1_nonblockingrev.pdf")
plt.close()
...
ax2.grid()
fig.tight_layout()
plt.savefig("np_graphs2_nonblockingrev.pdf")
plt.close()

# compare the reconstruction and decomposition times
fig = plt.figure(figsize=(x_img, y_img))
ax1 = fig.add_subplot(111)
ax1.plot(image4[:, 1], image4[:, 5]*1000, 'D-', label='768 x 768: scatter')
ax1.plot(image4[:, 1], image4[:, 6]*1000, 's--', label='768 x 768: gather')
ax1.set_xlabel(r"Number of processes, $N_{P}$", fontsize=20)
ax1.set_ylabel(r"Run time (ms)", fontsize=20)
ax1.set_xlim(1, 120)
# ax1.set_xlim(0)
ax1.legend(fontsize=20)
ax1.grid()
fig.tight_layout()
plt.savefig("np_input_output.pdf")
plt.close()
